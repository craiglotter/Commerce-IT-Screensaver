...
Begin VB.Form Form1 
   ...
   Caption         =   "Commerce IT Screensaver 20060131.3"
   ClientHeight    =   3810
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6555
   Icon            =   "Commerce_IT_Screensaver_Installer.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3810
   ...
   Begin VB.PictureBox Picture5 
      ...
      Height          =   255
      Left            =   720
      Picture         =   "Commerce_IT_Screensaver_Installer.frx":548A
      ScaleHeight     =   255
      ScaleWidth      =   255
      TabIndex        =   9
      Top             =   2160
   ...
   Begin VB.PictureBox Picture4 
      ...
      Height          =   255
      Left            =   720
      Picture         =   "Commerce_IT_Screensaver_Installer.frx":78A3
      ScaleHeight     =   255
      ScaleWidth      =   255
      TabIndex        =   5
      Top             =   1800
   ...
   Begin VB.PictureBox Picture3 
      ...
      Height          =   255
      Left            =   720
      Picture         =   "Commerce_IT_Screensaver_Installer.frx":9CBC
      ScaleHeight     =   255
      ScaleWidth      =   255
      TabIndex        =   4
      Top             =   1440
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   255
      Left            =   720
      Picture         =   "Commerce_IT_Screensaver_Installer.frx":C0D5
      ScaleHeight     =   255
      ScaleWidth      =   255
      TabIndex        =   3
      Top             =   840
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   255
      Left            =   3840
      Picture         =   "Commerce_IT_Screensaver_Installer.frx":E4EE
      ScaleHeight     =   255
      ScaleWidth      =   2535
      TabIndex        =   0
      Top             =   3360
   ...
   Begin VB.Label Label3 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Install Commerce IT Screensaver"
      ForeColor       =   &H00800000&
      Height          =   255
      Left            =   1080
      TabIndex        =   6
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Commerce IT Screensaver"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   15.75
         Charset         =   0
