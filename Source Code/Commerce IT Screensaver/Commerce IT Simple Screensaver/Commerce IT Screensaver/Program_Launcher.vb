Module Program_Launcher
    ...
    Private Sub Error_Handler(ByVal Message As String)
        Try
            MsgBox("Sorry, but the following error has been trapped by Commerce IT Screensaver 1.0: " & vbCrLf & Message, MsgBoxStyle.Exclamation, "Commerce IT Screensaver 1.0 Error")
        Catch ex As Exception
            MsgBox("Sorry, but the following error has been trapped by Commerce IT Screensaver 1.0: " & vbCrLf & ex.Message, MsgBoxStyle.Exclamation, "Commerce IT Screensaver 1.0 Error")
        End Try
    End Sub
